    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          ...
          <DialogDescription>
            Help others know how ResumeAI worked for you.
          </DialogDescription>
        </DialogHeader>
        <form onSubmit={handleSubmit} className="space-y-4 pt-4">
          ...
          <div className="space-y-2">
            ...
            <Textarea id="text" value={text} onChange={(e) => setText(e.target.value)} placeholder="How did ResumeAI help you?" className="min-h-[100px]" required />
          </div>
          <div className="space-y-2">
      ...
      <section ref={heroRef} className="relative z-10 max-w-6xl mx-auto px-6 pt-32 pb-24 text-center">
        ...
        >
          ...
          <motion.p variants={itemVariants} className="text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
            Paste a job description. Get a tailored resume, a match score, and a cover letter — in under 30 seconds. Built for people who apply smart, not often.
          </motion.p>
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6 py-32">
        ...
        {reviews && reviews.length > 0 ? (
          ...
          >
            ...
            <p className="text-muted-foreground mb-6">Be the first to share your experience with ResumeAI!</p>
          </motion.div>
        )}
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
            <div className="col-span-2 md:col-span-1">
              ...
              <p className="text-sm text-muted-foreground leading-relaxed mb-6">
                The smart way to tailor your resume and land more interviews. Free to start.
              </p>
            </div>
